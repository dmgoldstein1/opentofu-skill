...
> Pattern applies identically on Azure/GCP/Vultr; only provider/resource names change. See [Module Patterns: Cross-cloud resource map](module-patterns.md#cross-cloud-resource-map) and [Vultr Provider Patterns](vultr-provider.md).
